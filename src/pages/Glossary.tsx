...
const glossaryDescs: Array<String> = [
  ...
  "A set of hashed valid transactions, that meet the network required difficulty and are added to the chain.",
  "An ordering of data blocks linked by hash pointers and resembling a directed tree.",
  "A total order of data blocks linked by hash pointers in which any block references a previous one down to an originator called genesis block.",
  "A sequence of blocks strictly placed between two splitting blocks.",
  ...
  "A non-invertible hash function",
  ...
  "A hash lookup table in which the pointers are distributed. In a hash table, documents are called values, and hashes are called keys. In a distributed hash table, the mappings between the values and the keys are distributed.",
  "A copy of open-source software that starts its branch of separate development.",
  "A set with a binary relation. Objects in the set are usually called nodes or vertices, and a relation between two nodes is pictorially represented as an edge connecting two nodes.",
  ...
  "The seed in human-readable form.",
  ...
  "Money that needs no trusted third party to function.",
  "The consensus process through which the ledger’s data is protected against attackers aiming at overpowering the P2P network. This process uses outside resources such as silicon and electricity to increase the security of the network.",
  "A process where the owners of the money in a network can agree about the state of the network.",
